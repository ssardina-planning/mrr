...
import au.rmit.agtgrp.mrr.fol.symbol.Symbol;
import au.rmit.agtgrp.mrr.fol.symbol.Variable;
import au.rmit.agtgrp.mrr.fol.utils.Comparators;
import au.rmit.agtgrp.mrr.pct.Consumer;
import au.rmit.agtgrp.mrr.pct.PcLink;
import au.rmit.agtgrp.mrr.pct.PoclPlan;
import au.rmit.agtgrp.mrr.pct.Producer;
import au.rmit.agtgrp.mrr.pct.Threat;
...
import au.rmit.agtgrp.mrr.utils.collections.HashBijection;
import au.rmit.agtgrp.mrr.utils.collections.Pair;
import au.rmit.agtgrp.mrr.utils.collections.Triple;
...
public class PropositionMap implements Serializable {
	...
	public Plan decodeModel(int[] soln, PoclPlan plan) {
	...
	public Plan decodeGroundModel(int[] soln, PoclPlan plan, Substitution<Constant> sub) {
		if (soln.length != getNPropositions())
			throw new IllegalArgumentException("Illegal solution length: " + soln.length + 
					", expected " + getNPropositions() + "\n" + Arrays.toString(soln));
